...
body {
    ...
    background: linear-gradient(to bottom, #131720, #003b52, #00222f);
}
...
.home {
    ...
    width: 60%;
    margin: auto;
    margin-bottom: 4rem; /* margin can be changed */
    padding: 10rem 7rem;
    z-index: 100;
    border-radius: 10px;
    box-shadow: 5px 10px 15px #131720;
    background: linear-gradient(to bottom, #131720, #003347, #00222f);
}
...
.skills h1, .projects h1, .contact h1 {
    padding-top: 4rem;
    margin-bottom: 5rem;
    padding: 1rem auto;
    text-align: center;
